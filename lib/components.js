...
class Textbox extends Component {
  ...
  getTemplate() {
    ...
    if(this.props.options.type && this.props.options.type==imageFieldType)
    {
      return this.props.options.template || this.props.ctx.templates.file;
    }
    else{
...
class Select extends Component {
  ...
  getLocals() {
    ...
    ["help", "enabled", "mode", "prompt", "itemStyle", "textStyle"].forEach(
      name => (locals[name] = this.props.options[name])
    );
    return locals;
  }
